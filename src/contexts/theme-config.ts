 ...
 *
 * Template 2 (Honey): Farm-to-Jar / Premium Natural / Bee Edu — see PLAN-02-HONEY.md.
 */

export const THEMES = ['farm-to-jar', 'premium-natural', 'bee-edu'] as const
export type Theme = (typeof THEMES)[number]

export const DEFAULT_THEME: Theme = 'farm-to-jar'
...
> = {
  'farm-to-jar': {
    id: 'farm-to-jar',
    label: 'Farm-to-Jar',
    description: 'Warm honey golds and natural greens',
  },
  'premium-natural': {
    id: 'premium-natural',
    label: 'Premium',
    description: 'Refined natural palette',
  },
  'bee-edu': {
    id: 'bee-edu',
    label: 'Bee Edu',
    description: 'Bright, friendly contrast',
  },
}
